...
int move_is_ok() //  当棋子是否符合移动规则
{
    return chess_in[x][y] != 'a'                                                                                                                                                                                                                                        //该位置有子
           ...
           && (x >= 0 && x < 10)                                                                                                                                                                                                                                        //移动后未出界
           && (y >= 0 && y < 9) && (x + x_offset >= 0 && x + x_offset < 10) && (y + y_offset >= 0 && y + y_offset < 9) && ((chess_in[x + x_offset][y + y_offset] != 'a' && colour[x + x_offset][y + y_offset] != turn) || chess_in[x + x_offset][y + y_offset] == 'a'); //不能杀自己人
}
...
int pu() //  记谱功能
{
    ...
    else
    {
        ...
        else
        {
            ...
            if ((chess_in[x][y] >= 'b' && chess_in[x][y] <= 'e') || (chess_in[x][y] >= 'j' && chess_in[x][y] <= 'k'))
            {
                printf("%d", record_abs);
...
int name_ma() //  是否马的规则
{
    if ((y_offset == 2 && chess_in[x][y + 1] == 'a' && (x_offset == 1 || x_offset == -1)) //别马脚，四个方位
        || (y_offset == -2 && chess_in[x][y - 1] == 'a' && (x_offset == 1 || x_offset == -1)) || (x_offset == 2 && chess_in[x + 1][y] == 'a' && (y_offset == 1 || y_offset == -1)) || (x_offset == -2 && chess_in[x - 1][y] == 'a' && (y_offset == 1 || y_offset == -1)))
        go();
    return 0;
}
int name_xiang() //  是否象相的规则处理
{
    if (((x_offset == 2 && y_offset == -2 && chess_in[x + 1][y - 1] == 'a') //别象脚
         || (x_offset == -2 && y_offset == 2 && chess_in[x - 1][y + 1] == 'a') || (x_offset == -2 && y_offset == -2 && chess_in[x - 1][y - 1] == 'a') || (x_offset == 2 && y_offset == 2 && chess_in[x + 1][y + 1] == 'a')) &&
